...
Y si tu notebook excede la capacidad RAM (por ejemplo co paquetes pesados o gráficas muy detalladas), reduce el uso de esos paquetes y gráficas o ejecutas el Jupyter Notebook en tu computadora local (la cual probablemente tenga más de 2 Gb de memoria RAM).
